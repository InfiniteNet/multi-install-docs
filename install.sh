...
versao() {
echo -e "\e[97mSite: \e[32mhttps://autombot.infinitenet.net         \e[97mVersão do Autombot: \e[32mv.3.0\e[0m"
}
...
direitos_setup() {
    ...
    echo -e "$amarelo=  $branco aplicação disponíveis aqui. Este menu é licenciado sob a Licença IFNT (IFNT). Você pode usar, $amarelo =\e[0m"
    echo -e "$amarelo=  $branco  copiar, modificar, integrar, publicar, distribuir e/ou vender cópias dos produtos finais,  $amarelo  =\e[0m"
    echo -e "$amarelo=  $branco   mas deve sempre declarar que AutomBot (adm@infinitenet.net) é o autor original  $amarelo  =\e[0m"
    echo -e "$amarelo=  $branco           destes códigos e atribuir um link para https://autombot.infinitenet.net          $amarelo  =\e[0m"
    echo -e "$amarelo=                                                                                                 =\e[0m"
    echo -e "$amarelo===================================================================================================\e[0m"
    echo ""
    echo ""
...
info_credenciais(){ 
    echo -e "$amarelo===================================================================================================\e[0m"
    echo -e "$amarelo=                                                                                                 =\e[0m"
    echo -e "$amarelo=  $branco A partir da versão 2.5.0 deste menu foi implementado uma função para realizar deploy dentro $amarelo =\e[0m"
...
creditos_msg() {
    ...
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                                      32.813.988.0001/02                                    $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo===================================================================================================\e[0m"
...
serão utilizados para realizar as instalações no do aUTOMBOT v.2
